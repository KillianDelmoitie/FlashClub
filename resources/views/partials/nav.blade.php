    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          <li class="nav-item">
            <a class="nav-link {{ request()->is(LaravelLocalization::getCurrentLocale()) ? 'active' : '' }}" aria-current="page" href="{{ route('index') }}">{{ __('HOME') }}</a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ request()->is(LaravelLocalization::getCurrentLocale().'/events') ? 'active' : '' }}" href="{{ route('events') }}">{{ __('EVENTS') }}</a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ request()->is(LaravelLocalization::getCurrentLocale().'/gallery') ? 'active' : '' }}" href="{{ route('gallery') }}">{{ __('GALLERY') }}</a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ request()->is(LaravelLocalization::getCurrentLocale().'/contact') ? 'active' : '' }}" href="{{ route('contact') }}">{{ __('CONTACT') }}</a>
          </li>
        ...
        <ul class="navbar-nav d-flex ms-auto" >
          ...
          <li class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="{{ LaravelLocalization::getLocalizedURL('en', null, [], true) }}">EN</a>
              <a class="dropdown-item" href="{{ LaravelLocalization::getLocalizedURL('fr', null, [], true) }}">FR</a>
              <a class="dropdown-item" href="{{ LaravelLocalization::getLocalizedURL('nl', null, [], true) }}">NL</a>
            </div>
          </li>
